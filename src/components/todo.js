...
const Todo = () => (
  <div className="Todo">
    <ul>
      ...
      <li>Tilaa opiskelijakortti <Link href="https://www.frank.fi/opiskelijakortti/">Frankista</Link>, tärkeimpänä syynä 2,80€ hintainen opiskelijaruoka.</li>
      <li>
      ...
      <li>Osallistu varaslähtöön lauantaina 22.8. kello 14:30-> paikassa Q-talo, Nummenpuistokatu 2.</li>
